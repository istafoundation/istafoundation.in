...
import { FaFacebookF, FaInstagram, FaYoutube } from "react-icons/fa";  // ✅ replaced FaWhatsapp with FaYoutube
    ...
    return (
        <section className="relative isolate overflow-hidden">
            ...
            <aside className="hidden md:flex flex-col items-center gap-5 absolute left-2 top-1/2 -translate-y-1/2">
                <Social label="Facebook" href="https://facebook.com" icon={<FaFacebookF />} />
                <Social label="Instagram" href="https://instagram.com" icon={<FaInstagram />} />
                <Social label="YouTube" href="https://youtube.com" icon={<FaYoutube />} /> {/* ✅ replaced WhatsApp */}
            </aside>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-10 sm:gap-12 lg:gap-16 py-14 sm:py-16 lg:py-24">
                    ...
                    <div>
                        ...
                        <p className="mt-5 text-base sm:text-lg lg:text-xl leading-relaxed text-gray-700 max-w-prose">
                            Herding Cats My Grasp On Reality Right Now Is Tenuous Message The
                            Initiative Radical Candor.
                        </p>
